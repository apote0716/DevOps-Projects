...
```
![aaaa](https://github.com/apote0716/DevOps-Projects/assets/116959775/a686c139-1355-45c0-b365-35219a5c0ae3)

  * Next we install nodejs with this: `sudo apt install -y nodejs`
  
 ![bbb](https://github.com/apote0716/DevOps-Projects/assets/116959775/5eb29139-3fd8-42dd-8cf1-1b6a0006decc)
...
2. ##### Install MongoDB
  ...
  * Install MongoDB with the following comand: `sudo apt install -y mongodb`
  ...
  ![hsjkhf](https://github.com/apote0716/DevOps-Projects/assets/116959775/bc77a82a-f840-4215-8316-c52c29765b9e)

  
  * Verify Server is up and running: `sudo systemctl status mongodb`

  ![dkaksds](https://github.com/apote0716/DevOps-Projects/assets/116959775/5f44e020-0576-4f71-b5d8-bc777bdfa7ae)
 ...
 ![eeeee](https://github.com/apote0716/DevOps-Projects/assets/116959775/89f587cb-aa06-4fb7-879c-3659f901a261)
...
```
![fffff](https://github.com/apote0716/DevOps-Projects/assets/116959775/6cf5fbca-c4a6-48ea-9f4a-7aac431f1e4f)
 ...
 * Express will be used to pass book information to and from our MongoDB database and Mongoose will be used to establish a schema for the database to store data of our book register. To begin installation, type: `sudo npm install express mongoose` and enter.
 ...
 ![gggg](https://github.com/apote0716/DevOps-Projects/assets/116959775/6a2fa29d-b882-4907-bed0-b1353958c428)
...
module.exports = function(app) {
 ...
 ```
 ![hhhh](https://github.com/apote0716/DevOps-Projects/assets/116959775/ca77a959-292a-4be6-9a75-ef26e335ffca)
...
```
![iiiiii](https://github.com/apote0716/DevOps-Projects/assets/116959775/7fd24e89-2e05-44eb-9035-1b5e328bee73)
...
```
![jjjj](https://github.com/apote0716/DevOps-Projects/assets/116959775/9f6cda08-b285-453e-9e1a-4f0dff56c11e)
...
![llllllll](https://github.com/apote0716/DevOps-Projects/assets/116959775/f07ee3d6-2a3e-4642-9fd7-3aa8e0a355cf)
...
![Project4pix16](![mmmmm](https://github.com/apote0716/DevOps-Projects/assets/116959775/a25f7740-7489-4b8e-8d91-7a59a92bed85)


* Next I accessed the HTML page over the internet via port 3300 using the public IP: `http://34.200.223.160:3300/`

![nnnnnnn](https://github.com/apote0716/DevOps-Projects/assets/116959775/b63f514b-76aa-4154-8864-483f37ec9cfa)


* Finally I enter some data into the database and it reflected.

![oooooo](https://github.com/apote0716/DevOps-Projects/assets/116959775/6f3faf00-36d5-44f8-b6f5-53073957a4d1)
