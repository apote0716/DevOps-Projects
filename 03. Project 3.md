...
##### MONGODB DATABASE
* A database is required to store data. For this we will make use of mLab. Sign up for a shared clusters free account, Sign up on https://www.mongodb.com/atlas-signup-from-mlab. Follow the sign up process, select AWS as the cloud provider, and choose a region.
...
* Using Vim, follow the below steps: Open the file with `vim index.js` and enter. Type`:` then type `%d` and enter. this will delete the entire content. Next, press `i` to enter the insert mode in vim. then, paste the entire code below in the file:
```
const express = require('express');
...
![DSJDBBS](https://github.com/apote0716/DevOps-Projects/assets/116959775/298c6e14-76e5-4439-b241-7ae4c32fe7e9)
...
* Next, go to the components directory: `cd src/components`
...
![sbhsaD](https://github.com/apote0716/DevOps-Projects/assets/116959775/17d3d108-b172-498f-9fd4-92d8d42f2da8)
